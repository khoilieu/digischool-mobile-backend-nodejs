...
const subjectSchema = new mongoose.Schema({
  ...
  subjectCode: {
    ...
    validate: {
      ...
      message: 'Subject code must be 2-6 characters long and contain only letters and numbers'
    }
  },
  description: {
    type: String,
  ...
  gradeLevels: {
    ...
    validate: {
      ...
      message: 'Grade levels must be between 1 and 12, and at least one grade level is required'
    }
  },
  credits: {
    type: Number,
