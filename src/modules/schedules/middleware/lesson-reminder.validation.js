...
const createReminderValidation = [
  body('testType')
    .optional()
    .isIn(['kiemtra15', 'kiemtra1tiet', 'kiemtrathuchanh', 'kiemtramieng', 'baitap', 'other'])
    .withMessage('Test type must be one of: kiemtra15, kiemtra1tiet, kiemtrathuchanh, kiemtramieng, baitap, other'),
...
module.exports = {
  createReminderValidation: [...createReminderValidation, handleValidationErrors],
  updateReminderValidation: [...updateReminderValidation, handleValidationErrors],
